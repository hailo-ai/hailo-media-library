                                             ...
                                             guint max_buffers, gsize size, guint padding)
{
    ...
    GST_DEBUG_OBJECT(pool,
                     "Dma-buf bufferpool created with buffer size: %ld min buffers: %d max buffers: %d and padding: %d",
                                                         ...
                                                         guint bufferpool_max_size)
{
    ...
    pool = gst_hailo_dma_create_new_pool(GST_CAT_DEFAULT, caps, bufferpool_min_size, bufferpool_max_size, buffer_size,
                                         padding);
