...
#define GST_TYPE_HAILO_DSP_BASE_TRANSFORM (gst_hailo_dsp_base_transform_get_type())
...
#define GST_IS_HAILO_DSP_BASE_TRANSFORM(obj) (G_TYPE_CHECK_INSTANCE_TYPE((obj), GST_TYPE_HAILO_DSP_BASE_TRANSFORM))
#define GST_IS_HAILO_DSP_BASE_TRANSFORM_CLASS(klass)                                                                   \
    (G_TYPE_CHECK_CLASS_TYPE((klass), GST_TYPE_HAILO_DSP_BASE_TRANSFORM))
#define GST_HAILO_DSP_BASE_TRANSFORM_CAST(obj) ((GstHailoDspBaseTransform *)(obj))
...
GType gst_hailo_dsp_base_transform_get_type(void);
