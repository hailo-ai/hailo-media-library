...
.. code-block:: cpp
   ...
   // Configure frontend (assumes media_library->m_frontend exists)
   frontend_stage->configure(media_library->m_frontend);
...
.. code-block:: cpp
   ...
   // Configure encoder (assumes encoder MediaLibraryEncoderPtr exists)
   encoder_stage->configure(encoder);
