...
nlohmann::json webserver::pipeline::Pipeline::create_encoder_osd_config(WebserverResourceRepository resources)
{
...
std::string webserver::pipeline::Pipeline::create_gst_pipeline_string()
{
...
void Pipeline::callback_handle_strategy(ResourceStateChangeNotification notif)
{
    ...
    case RESOURCE_ENCODER:
    {
        ...
        auto enc_config = m_resources->get(RESOURCE_ENCODER)->get();
