...
hailo_analytics::pipeline::AppStatus ThumStorageStage::init()
{
    switch (m_db_source)
    {
...
hailo_analytics::pipeline::AppStatus ThumStorageStage::deinit()
{
...
hailo_analytics::pipeline::AppStatus ThumStorageStage::process(hailo_analytics::pipeline::BufferPtr data)
{
...
void ThumStorageStage::database_access()
{
...
int64_t ThumStorageStage::get_current_epochmilliseconds()
{
...
std::string ThumStorageStage::generate_epoch_filename(const std::string &prefix, int64_t epoch_millis,
...
ThumStorageStageBuild::Builder &ThumStorageStageBuild::Builder::set_stage_name(std::string name)
{
    m_stage_name = name;
    return *this;
}

ThumStorageStageBuild::Builder &ThumStorageStageBuild::Builder::set_database_source(DBSource source)
{
    m_db_source = source;
    return *this;
}

ThumStorageStageBuild::Builder &ThumStorageStageBuild::Builder::set_database_source_data(std::string data)
{
    m_db_source_data = data;
    return *this;
}

ThumStorageStageBuild::Builder &ThumStorageStageBuild::Builder::set_thumbnail_path(std::string path)
{
    m_thumb_dir = path;
    return *this;
}

ThumStorageStageBuild::Builder &ThumStorageStageBuild::Builder::set_thumbnail_file_prefix(std::string prefix)
{
    m_thumb_filename_prefix = prefix;
    return *this;
}

ThumStorageStageBuild::Builder &ThumStorageStageBuild::Builder::set_queue_size_opt(size_t size)
{
    m_queue_size = size;
    return *this;
}

ThumStorageStageBuild::Builder &ThumStorageStageBuild::Builder::set_leaky_opt(bool activate)
{
    m_leaky = activate;
    return *this;
}

ThumStorageStageBuild::Builder &ThumStorageStageBuild::Builder::set_trace_opt(bool activate)
{
    m_trace = activate;
    return *this;
}

std::shared_ptr<ThumStorageStage> ThumStorageStageBuild::Builder::buildptr() const
{
    ...
    return std::make_shared<ThumStorageStage>(m_stage_name.value(), m_db_source, m_db_source_data.value(),
                                              m_thumb_dir.value(), m_thumb_filename_prefix.value(), m_queue_size,
                                              m_leaky, m_trace);
}

ThumStorageStageBuild::Builder ThumStorageStageBuild::create()
{
    return Builder();
}
