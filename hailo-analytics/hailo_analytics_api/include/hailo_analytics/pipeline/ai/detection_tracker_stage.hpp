...
inline constexpr uint16_t DETECTION_TRACKER_MAX_TRACKLETS_DEFAULT = 1000;
    ...
    class Builder
    {
      private:
        ...
        hailo_tracker_config_t m_tracker_config = []() {
            ...
            cfg.max_tracklets = DETECTION_TRACKER_MAX_TRACKLETS_DEFAULT;
            return cfg;
        }();
        std::map<uint8_t, std::string> m_labels_map;
        std::string m_mot_output_path;
