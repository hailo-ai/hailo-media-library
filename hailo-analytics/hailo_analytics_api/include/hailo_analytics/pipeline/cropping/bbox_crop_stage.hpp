...
class BBoxCropStage : public DspBaseCropStage
{
  ...
  public:
     ...
     * @param release_input_after_dsp See DspBaseCropStage.
     */
    BBoxCropStage(std::string name, int output_pool_size, int input_width, int input_height, int output_width,
                  ...
                  size_t max_crops = std::numeric_limits<size_t>::max(), bool release_input_after_dsp = false);
  ...
  public:
    ...
    class Builder
    {
      ...
      private:
        ...
        bool m_release_input_after_dsp = false;
      ...
      public:
        ...
        /**
         * @brief Release the input frame buffer immediately after DSP crops complete.
         * @param enable If true, opts in to the early release.
         * @return Builder reference for chaining
         */
        Builder &set_release_input_after_dsp(bool enable);
