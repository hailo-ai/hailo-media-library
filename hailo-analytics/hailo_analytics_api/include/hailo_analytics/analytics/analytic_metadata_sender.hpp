...
/**
 * @brief Configuration structure for analytic metadata packager stages.
 *
 * Contains all configurable parameters for AnalyticMetadataPackagerStage builders.
...
struct analytic_metadata_config_t
{
    ...
    /**
     * @brief Merge configuration from another analytic_metadata_config_t.
    ...
    /**
     * @brief Apply this configuration to an AnalyticMetadataPackagerStageBuild::Builder.
...
/**
 * @brief Get default configuration for analytic metadata packager stage.
 *
 * @return analytic_metadata_config_t with sensible defaults
 */
...
/**
 * @brief Generate an analytic metadata sender pipeline.
 *
...
generate_analytic_metadata_sender_pipeline(
    const std::string &pipeline_name = "analytic_metadata_sender_pipeline",
