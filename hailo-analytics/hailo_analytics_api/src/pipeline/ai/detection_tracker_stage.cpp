    ...
    const hailo_tracklets_t &tracklets) const
{
    ...
    for (size_t i = 0; i < tracklets.count; i++)
    {
        ...
        HailoBBox bbox(tracklet.detection.x_min, tracklet.detection.y_min,
                       tracklet.detection.x_max - tracklet.detection.x_min,
                       tracklet.detection.y_max - tracklet.detection.y_min);
