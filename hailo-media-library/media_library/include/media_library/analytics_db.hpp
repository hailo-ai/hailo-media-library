...
{
    Timestamp ts;
    std::vector<hailo_semantic_segmentation_mask_t> analytics_buffer;
    std::vector<HailoMediaLibraryBufferPtr>
        medialib_buffer_ptrs; // Vector of buffers holding all allocated buffers for the frame
};
