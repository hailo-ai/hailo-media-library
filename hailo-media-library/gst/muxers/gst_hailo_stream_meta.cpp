...
static gboolean gst_hailo_stream_meta_init(GstMeta *meta, [[maybe_unused]] gpointer params,
...
static void gst_hailo_stream_meta_free(GstMeta *meta, [[maybe_unused]] GstBuffer *buffer)
{
    GstHailoStreamMeta *stream_meta = (GstHailoStreamMeta *)meta;
...
static gboolean gst_hailo_stream_meta_transform(GstBuffer *transbuf, GstMeta *meta, [[maybe_unused]] GstBuffer *buffer,
                                                [[maybe_unused]] GQuark type, [[maybe_unused]] gpointer data)
{
