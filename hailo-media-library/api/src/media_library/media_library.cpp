                                           ...
                                           bool restart_required)
{
    ...
    // PRE-ISP SDR <-> PRE ISP DENOISE
    bool fast_denoise_switch_active = (previous_profile.iq_settings.denoise.fast_denoise_switch ||
                                       new_profile.iq_settings.denoise.fast_denoise_switch) &&
                                      denoise_bayer_changed && !hdr_changed;
    ...
    if (!fast_denoise_switch_active)
    {
        pause_required |= previous_profile.iq_settings.denoise.fast_denoise_switch !=
                          new_profile.iq_settings.denoise.fast_denoise_switch;
